...
void setLFFlux(REAL &BigG, REAL *conVL, REAL *conVR, REAL *flux) {
    ...
    REAL e_L = 1.5 * theta_L - 1.0 + sqrt(1.0 + 9.*theta_L * theta_L / 4.0), e_R = 1.5 * theta_R - 1.0 + sqrt(1.0 + 9.*theta_R * theta_R / 4.0);
    REAL h_L = 1 + e_L + pre_L / rho_L, h_R = 1 + e_R + pre_R / rho_R;

    REAL gas_csL = sqrt((9.*theta_L * theta_L + 10.*theta_L * sqrt(1.0 + 9.*theta_L * theta_L / 4.0))
                        / 6.0 / (6.*theta_L * theta_L + 4.*theta_L * sqrt(1.0 + 9.*theta_L * theta_L / 4.0) + 1.0));
    REAL gas_csR = sqrt((9.*theta_R * theta_R + 10.*theta_R * sqrt(1.0 + 9.*theta_R * theta_R / 4.0))
                        / 6.0 / (6.*theta_R * theta_R + 4.*theta_R * sqrt(1.0 + 9.*theta_R * theta_R / 4.0) + 1.0));
