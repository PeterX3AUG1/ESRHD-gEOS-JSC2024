% 画熵-DS随时间变化的曲线
clear,clc
data1 = load('tolEntr_1DRP2_400_RRK_ES5_SO.txt');
t1 = data1(:,1); S1 = data1(:,2);
data2 = load('tolEntr_1DRP2_200_RRK_ES5_SO.txt');
t2 = data2(:,1); S2 = data2(:,2);
data3 = load('tolEntr_1DRP2_100_RRK_ES5_SO.txt');
...
print -depsc2 RHD_tolEntr_1DRP2_ES5_RRK_EOS_3.eps