% 画熵-DS随时间变化的曲线
clear,clc
data1 = load('tolEntr_1DRP2_400_EOS_3_ES5.txt');
t1 = data1(:,1); S1 = data1(:,2);
data2 = load('tolEntr_1DRP2_200_EOS_3_ES5.txt');
t2 = data2(:,1); S2 = data2(:,2);
data3 = load('tolEntr_1DRP2_100_EOS_3_ES5.txt');
...
print -depsc2 RHD_tolEntr_1DRP_2_ES5_400_EOS_3.eps