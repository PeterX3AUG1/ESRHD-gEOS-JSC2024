...
data1 = load('RP_1_priU_RK3_EOS_1_ES5_400.dat');
data2 = load('RP_1_priU_RRK3_EOS_1_ES5_400_SO.dat');
...
% xlim([0.5 0.53])
print -depsc2 RHD1D_RP_1_CMP_EOS1_density_RRK.eps
figure(2)
...
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
% xlim([0.5 0.53])
print -depsc2 RHD1D_RP_1_CMP_EOS1_velocity_RRK.eps
figure(3)
...
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
% xlim([0.5 0.53])
print -depsc2 RHD1D_RP_1_CMP_EOS1_pressure_RRK.eps