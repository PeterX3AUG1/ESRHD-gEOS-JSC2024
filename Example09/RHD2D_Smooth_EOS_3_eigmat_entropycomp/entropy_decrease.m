% 画熵-DS随时间变化的曲线
clear,clc
data1 = load('tolEntr_2DSmooth80_EOS_3_EC6.txt');
t1 = data1(:,1); S1 = data1(:,2);
data2 = load('tolEntr_2DSmooth80_EOS_3_ES5.txt');
t2 = data2(:,1); S2 = data2(:,2);
data3 = load('tolEntr_2DSmooth160_EOS_3_ES5.txt');
t3 = data3(:,1); S3 = data3(:,2);
data4 = load('tolEntr_2DSmooth320_EOS_3_ES5.txt');
...
print -depsc2 RHD_tolEntr_2DSmooth_EOS_3.eps