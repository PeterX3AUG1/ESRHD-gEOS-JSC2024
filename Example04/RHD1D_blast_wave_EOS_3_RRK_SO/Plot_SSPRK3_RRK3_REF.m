...
data1 = load('blast_wave_priU_RK3_EOS_3_ES5_4000.dat');
data2 = load('blast_wave_priU_RRK3_EOS_3_ES5_4000_SO.dat');
data_num = load('rhoup.txt');
...
xlim([0.5 0.53])
print -depsc2 RHD1D_blast_wave_CMP_EOS3_density_RRK.eps
figure(2)
...
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
xlim([0.5 0.53])
print -depsc2 RHD1D_blast_wave_CMP_EOS3_velocity_RRK.eps
figure(3)
...
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
xlim([0.5 0.53])
print -depsc2 RHD1D_blast_wave_CMP_EOS3_pressure_RRK.eps