...
void Euler1D::OutputOrder() {
    ...
    ofstream err("err_1DEC6_RRK_EOS_3.txt", ios::app);
    ...
    linf_order = logq(linf_errold / linf_error) / logq(2.0);
    l1_order = logq(l1_errold / l1_error) / logq(2.0);
    l2_order = logq(l2_errold / l2_error) / logq(2.0);
