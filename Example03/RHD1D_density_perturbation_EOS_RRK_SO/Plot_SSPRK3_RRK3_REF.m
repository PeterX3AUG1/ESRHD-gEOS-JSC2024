...
data1 = load('density_perturbation_priU_RK3_EOS_1_ES5_400.dat');
data2 = load('density_perturbation_priU_RRK3_EOS_1_ES5_400_SO.dat');
data_num = load('density_perturbation_priU_RK3_EOS_1_LF_100000.dat');
...
hold on
plot(xe(1+gpn:end-gpn),rRRK,'rs','markersize',3)
plot(xe_num(1+gpn:end-gpn),r_num,'k-','linewidth',2)
axis square
% legend('ES5 solution','reference solution','location','northeast','fontsize',6);
% xlim([0.5 0.53])
print -depsc2 RHD1D_density_perturbation_CMP_EOS1_density_RRK.eps
figure(2)
plot(xe(1+gpn:end-gpn),u,'bo','markersize',4)
hold on
plot(xe(1+gpn:end-gpn),uRRK,'rs','markersize',3)
plot(xe_num(1+gpn:end-gpn),u_num,'k-','linewidth',2)
axis square
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
% xlim([0.5 0.53])
print -depsc2 RHD1D_density_perturbation_CMP_EOS1_velocity_RRK.eps
figure(3)
plot(xe(1+gpn:end-gpn),p,'bo','markersize',4)
hold on
plot(xe(1+gpn:end-gpn),pRRK,'rs','markersize',3)
plot(xe_num(1+gpn:end-gpn),p_num,'k-','linewidth',2)
axis square
% legend('ES5 solution','reference solution','location','northeast','fontsize',6)
% xlim([0.5 0.53])
print -depsc2 RHD1D_density_perturbation_CMP_EOS1_pressure_RRK.eps